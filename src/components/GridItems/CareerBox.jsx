...
const CareerBox = () => {
  ...
  return (
    <Box onClick={()=> console.log(123)}>
      <Title>Career <small>클릭을 하면 상세히 볼 수 있습니다.</small></Title>
      <CareerContainer>
      {/* https://imgs.jobkorea.co.kr/img1/_whitebg/200X80/Co_Logo/Logo/2023/4/2979v00aRg_fKvv8b9xv3422g0gvYtIx_5k5y2vg.gif?v=202405291456&hash=r&serviceCode=CL */}
        ...
        <br/><br/>
        해당 회사에서 프론트엔드, 백엔드, 서버, 데이터베이스 개발 및 서비스 유지보수를 맡아서 했습니다.
